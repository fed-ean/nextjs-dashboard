    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <aside className="lg:col-span-3 space-y-8">
          <div className="sticky top-24">{/* SidenavServer puede agregarse aquí si lo deseas */}</div>
        </aside>
        <main className="lg:col-span-9">
          ...
          <div className="mt-8">
            <CategoryPagination basePath="/interes-general" current={page} totalPages={totalPages} />
          </div>
        </main>
      </div>
    </div>
