...
export default function CarouselCard({ noticia }: { noticia: Noticia }) {
  ...
  const { slug, titulo, imagenUrl, fechaPublicacion, categories } = noticia;
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row max-w-7xl mx-auto" style={{ minHeight: '400px' }}>
      ...
      <div className="relative h-96 md:h-auto md:w-1/2">
        <Image
          src={imagenUrl || '/RadioAColor1.png'}
      ...
      <div className="md:w-1/2 p-8 flex flex-col justify-center">
        <h3 className="text-3xl font-alegreya-extrabold mb-4 text-gray-800 hover:text-blue-600 transition-colors">
