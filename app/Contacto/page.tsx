...
export const metadata = {
  title: "Contacto | Radio Empresarial",
  description: "Contacto, sponsors y quiénes somos - Radio Empresaria",
};
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 px-4">
            {SPONSORS.map((s) => (
              <a
                ...
                "
              >
                {/* plain <img> avoids Next build-time optimization errors */}
                <img
                  src={s.src}
                  alt={s.alt}
                  width={250}
...
const SPONSORS = [
  // RECOMENDACIÓN: guardá las imágenes en public/sponsors/ y usá esas rutas aquí
